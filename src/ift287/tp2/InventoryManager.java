...
public class InventoryManager 
{
	...
	private void addCards(int nbrCartes, Joueur joueur){
		...
		try{
			for (int i = 0; i < nbrCartes; i++){
	        	...
	        	System.out.println("Entrez l��quipe de la carte " + num + " :");
	            equipeCarte = br.readLine();
	        	
	        	System.out.println("Entrez l�ann�e de parution de la carte " + num + " :");
	...
	private int showInfoPlayer(){
		...
		try{
           ...
           if(position == players.size()){
        	   ...
        	   System.out.println("Voici l'information sauvegard� de: " + players.get(position).getNomJoueur());
        	   int nbrCartes = players.get(position).getNombreCartes();
        	   System.out.println("Le joueur a " + nbrCartes + " cartes enregistr�es");
        	   ...
        	   for (int j = 0; j < nbrCartes; j++){
        		...
        		System.out.println("Carte " + num + " :");
               	...
               	System.out.println("�quipe : " + cartes.get(j).getNomEquipe());
               	System.out.println("Ann�e de parution :  " + cartes.get(j).getAnneeSortie());
               } 
           } 
        } catch (IOException e) {
			e.printStackTrace();
	...
	private void updatePlayer(){
		...
		try{
			if(position != players.size()){
				System.out.println(" ");
				System.out.println("Maintenant entr�e les donn�es � modifier:");
	          	System.out.println("Entrez le nom du joueur:");
	          	nomJoueur = br.readLine();
		...
		try{
			if(position != players.size()){
	           ...
	           if (reponse.equals("O") || reponse.equals("o")){
	        	   ...
	        	   System.out.println("L'information du joueur " + nomJoueur + " a �t� efface du syst�me.");
	           }
	           else {
	        	   System.out.println("L'information du joueur " + nomJoueur + " n'a pas �t� efface du syst�me.");
	           }
			}
		}catch(NumberFormatException nfe){
            System.err.println("Invalid Format!");
		...
		try{
			...
			case "E": 
				for(Joueur j: players)
				{
					...
					System.out.println("Voici l'information sauvegard� de : " + j.getNomJoueur());
					System.out.println("Le joueur a " + j.getNombreCartes() + " cartes enregistr�es");
					ArrayList<Carte> cartes = j.getCartes();
					for (int i = 0; i < j.getNombreCartes(); i++){
		        		   int num = i+1;
		        		System.out.println("Carte " + num + " :");
		               	System.out.println("Titre : " + cartes.get(i).getTitreCarte());
		               	System.out.println("�quipe : " + cartes.get(i).getNomEquipe());
		               	System.out.println("Ann�e de parution :  " + cartes.get(i).getAnneeSortie());
		               }
					System.out.println("\n");
				}
				break;
			case "F":
				...
				System.out.println("Liste des joueurs � l'endroit suivant : " + storageFile.getPath());
				...
				break;
			default:
				System.out.println("Choix invalide, veuillez entr�e E ou F");
				break;
			}
		}
		catch (IOException e) {
